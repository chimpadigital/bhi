<template>
  <div v-if="user">
    ...
    <div class="flex flex-col lg:flex-row border-b-2 border-bhi-primary mb-10">
      <nuxt-link
        :to="$route.path.substring(0, $route.path.indexOf('/confirm'))"
...
o alergía alimenticia."
      ...
      <div class="w-full lg:w-1/2">
        ...
        <div class="mb-4">
          ...
          <div class="relative lg:w-2/5">
            <input class="input-bhi pl-12 w-full z-0 cursor-pointer" type="text" placeholder="Adjuntar" disabled>
    ...
    <div class="flex flex-col lg:flex-row justify-center">
      <div
        class="btn-bhi-primary lg:mr-4 text-center flex items-center py-2"
        @click="download(true)"
      >
        <svg style="transform:rotate(-90deg)" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">
          <circle
        ...
        <span class="ml-2">Descargar comprobante</span>
      </div>
      <div
        class="btn-bhi-primary mt-4 lg:mt-0 text-center py-2"
...
export default {
  ...
  mounted () {
    const user = JSON.parse(localStorage.getItem('client.agency.confirm'))
    if (user) {
      this.user = user
    }
  },
  methods: {
    ...
    download (bool) {
      ...
      if (bool) {
        return this.$nuxt.$emit('ADMIN_ACTION_ACTIVE', 'comprobante')
      }

      this.$nuxt.$emit('ADMIN_ACTION_ACTIVE', 'cambios-guardados')
    }
  }
}
</script>
